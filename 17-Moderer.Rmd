...
```{r jn1, fig.cap="Le graphique Johnson-Neyman pour interpréter les effets modérateurs", cache = TRUE}
...
```{r modex1, fig.cap = "Diagramme de trajectoire (Question 3)", echo = FALSE, out.height="50%", out.width="50%", fig.align = "center"}
knitr::include_graphics("image//modex1.png")
```
...
```{r modex2, fig.cap = "Diagramme de trajectoire (Question 4)", echo = FALSE, out.height="50%", out.width="50%", fig.align = "center"}
knitr::include_graphics("image//modex2.png")
```
...
```{r modex3, fig.cap = "Diagramme de trajectoire (Question 5)", echo = FALSE, out.height="50%", out.width="50%", fig.align = "center"}
knitr::include_graphics("image//modex3.png")
```
