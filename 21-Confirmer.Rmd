...
```{r leplot, fig.cap="Représentation graphique de la structure factorielle finale.", fig.align="center", out.height='75%', out.width='75%'}
...
```{r lesem, fig.cap="Représentation graphique du modèle acheminatoire.",fig.align="center", out.height='75%', out.width='75%'}
