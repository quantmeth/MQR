...
```{r acpsuj, echo = FALSE, fig.align='center',fig.cap='Représentations des participants selon les variables (gauche) et les composantes principales (droite).', out.height="75%", out.width="75%"}
r.svd <- svd(jd.acp)
...
```{r varacp, echo = FALSE, fig.align='center', fig.cap="Représentations des variables selon les composantes principales.", out.height="75%", out.width="75%"}
