...
Pour télécharger le logiciel, il faut se rendre sur le site <http:rstudio.com> et naviguer jusqu'au téléchargement du logiciel. La version gratuite de **R**Studio est téléchargeable spécifiquement sur cette page  <https://www.rstudio.com/products/rstudio/download/#download>. **R**Studio est uniquement disponible en anglais.
