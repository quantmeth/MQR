...
Ces système d'équation est toujours indéterminé. Pour le résoudre, la solution est de fixer arbitrairement à l'un des éléments de $\mathbf{V}$, comme $v_{11} = v_{12} = 1$. 
