...
Conceptuellement, **R** [importe][Importer] des données pour les [manipuler] et [produire des graphiques][Visualiser]. Elles ne sont pas entrées dans le logiciel. Il existe toutefois quelques méthodes pour ce faire, dont en voici une courte liste. **Ces méthodes sont présentées; elles ne sont pas recommandées**.
