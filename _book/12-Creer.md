...
Dans ce chapitre^[La section est partiellement basée sur @Caron21.], des techniques de modélisation avancées sont présentées. Elles s'appliquent à des modèles de trajectoires récursifs, c'est-à-dire que la *causation* s'enchaîne dans une direction, de la première variable vers la dernière. 
