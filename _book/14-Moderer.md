...
> -3.0763 -0.6624  0.0439  0.6712  2.7483 
> 
> Coefficients:
>             Estimate Std. Error t value Pr(>|t|)    
> (Intercept)  0.00574    0.04482    0.13  0.89813    
> x            0.15174    0.04858    3.12  0.00189 ** 
> w            0.16712    0.04850    3.45  0.00062 ***
> x:w          0.33400    0.03912    8.54  < 2e-16 ***
> ---
> Signif. codes:  
> 0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
> 
> Residual standard error: 0.944 on 496 degrees of freedom
> Multiple R-squared:  0.165,	Adjusted R-squared:  0.16 
...
> (Intercept)   1      7     7.3    8.17  0.0044 ** 
> x             1     15    14.5   16.29 6.3e-05 ***
> w             1      8     7.8    8.75  0.0032 ** 
> x:w           1     65    64.9   72.88 < 2e-16 ***
> Residuals   496    442     0.9                    
> ---
> Signif. codes:  
> 0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
> (Intercept)      0   1    0.02 0.89813    
> x                9   1    9.76 0.00189 ** 
> w               11   1   11.88 0.00062 ***
> x:w             65   1   72.88 < 2e-16 ***
> Residuals      442 496                    
> ---
> Signif. codes:  
> 0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
> 
> When w is OUTSIDE the interval [-0.64, 0.16], the slope
> of x is p < .05.
> 
> Note: The range of observed values of w is [-2.99, 3.14]
```

<div class="figure">
<img src="14-Moderer_files/figure-html/jn1-1.png" alt="Le graphique Johnson-Neyman pour interpréter les effets modérateurs" width="672" />
...
> SIMPLE SLOPES ANALYSIS 
> 
> Slope of x when w = -0.94712 (- 1 SD): 
> 
>    Est.   S.E.   t val.      p
> ------- ------ -------- ------
>   -0.19   0.07    -2.90   0.00
> 
> Slope of x when w =  0.00994 (Mean): 
> 
>   Est.   S.E.   t val.      p
> ------ ------ -------- ------
>   0.05   0.05     1.13   0.26
> 
> Slope of x when w =  0.96699 (+ 1 SD): 
> 
>   Est.   S.E.   t val.      p
> ------ ------ -------- ------
>   0.30   0.06     5.05   0.00
