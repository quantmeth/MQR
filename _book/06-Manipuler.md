...
<!-- Le présent ouvrage tente de monter une approche intuitive et simple, mais il ne faut pas en faire un dogme. -->
...
Avant de commencer, il faut rendre le package `tidyverse` disponible, car plusieurs fonctions seront utiles et le jeu de donnée s'y trouve.
