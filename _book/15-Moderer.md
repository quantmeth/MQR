...
> -2.729 -0.557 -0.034  0.598  2.279 
> 
> Coefficients:
>             Estimate Std. Error t value Pr(>|t|)    
> (Intercept)   0.0649     0.0424    1.53  0.12657    
> x             0.1450     0.0422    3.43  0.00064 ***
> w             0.2004     0.0452    4.43  1.2e-05 ***
> x:w           0.3177     0.0366    8.69  < 2e-16 ***
> ---
> Signif. codes:  
> 0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
> 
> Residual standard error: 0.876 on 496 degrees of freedom
> Multiple R-squared:  0.189,	Adjusted R-squared:  0.184 
> F-statistic: 38.5 on 3 and 496 DF,  p-value: <2e-16
...
> (Intercept)   1     17    17.5    22.8 2.4e-06 ***
> x             1     20    20.3    26.5 3.8e-07 ***
> w             1     10    10.3    13.4 0.00028 ***
> x:w           1     58    57.9    75.5 < 2e-16 ***
...
> (Intercept)      2   1    2.34 0.12657    
> x                9   1   11.79 0.00064 ***
> w               15   1   19.63 1.2e-05 ***
> x:w             58   1   75.49 < 2e-16 ***
> Residuals      380 496                    
> ---
> Signif. codes:  
> 0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
> Warning: le package 'interactions' a été compilé avec la
> version R 4.2.2
```
...
<div class="figure">
<img src="15-Moderer_files/figure-html/ip1-1.png" alt="Analyse de pentes simples pour un modérateur nominal" width="672" />
...
<div class="figure">
<img src="15-Moderer_files/figure-html/ip2-1.png" alt="Analyses des pentes simples pour un modérateur continu" width="672" />
...
<div class="figure">
<img src="15-Moderer_files/figure-html/ip3-1.png" alt="Analyses des pentes simples pour un modérateur continu" width="672" />
...
> 
> When w is OUTSIDE the interval [-0.31, 0.25], the slope
> of x is p < .05.
> 
> Note: The range of observed values of w is [-3.06, 3.19]
```

<div class="figure">
<img src="15-Moderer_files/figure-html/jn1-1.png" alt="Le graphique Johnson-Neyman pour interpréter les effets modérateurs" width="672" />
...
> SIMPLE SLOPES ANALYSIS 
> 
> Slope of x when w = -1.0115 (- 1 SD): 
> 
>    Est.   S.E.   t val.      p
> ------- ------ -------- ------
>   -0.31   0.06    -5.32   0.00
> 
> Slope of x when w = -0.0266 (Mean): 
> 
>   Est.   S.E.   t val.      p
> ------ ------ -------- ------
>   0.00   0.04     0.02   0.98
> 
> Slope of x when w =  0.9583 (+ 1 SD): 
> 
>   Est.   S.E.   t val.      p
> ------ ------ -------- ------
>   0.32   0.06     5.64   0.00
