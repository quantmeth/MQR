...
```{r Pigeon, fig.cap="Pigeon compressé à divers niveaux de dimension $k$",echo=FALSE, fig.align="center", out.height="150%"}
knitr::include_graphics("image//pigeon.pdf")
```
...
```{r scree, fig.cap="Les valeurs propres en fonctions de la position de l'axe"}
plot(res$values,
     type = "b")
```
...
```{r scree2, fig.cap="Comparaison des valeurs propres empiriques et simulées"}
