...
```{r erreurbar4, fig.cap="Comparaison de deux temps de mesure avec `superb` (sans décorrélation)", fig.align='center', out.height="75%", out.width="75%", warning = FALSE}
superbPlot(jd_intra, 
    WSFactors = "temps(2)", 
...
```{r erreurbar5, fig.cap="Comparaison de deux temps de mesure avec `superb` (avec décorrélation)", fig.align='center', out.height="75%", out.width="75%", warning = FALSE}
superbPlot(jd_intra, 
    WSFactors = "temps(2)", 
    variables = c("temps1", "temps2"),
    plotStyle = "line",
