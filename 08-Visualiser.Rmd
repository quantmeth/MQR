...
```{r hist2, fig.cap="Histogrammes de l'IMC par rapport au sexe", fig.align='center', out.height="75%", out.width="75%",message=FALSE,warning=FALSE}
jd %>% 
...
```{r erreurbar2, fig.cap="Les effets de la vitamine C sur les cochons d'inde avec `superb`", fig.align='center', out.height="75%", out.width="75%", warning = FALSE,message=FALSE}
library(superb)
...
```{r erreurbar4, fig.cap="Comparaison de deux temps de mesure avec `superb` (sans décorrélation)", fig.align='center', out.height="75%", out.width="75%", message=FALSE, warning = FALSE}
superbPlot(jd_intra, 
    WSFactors = "temps(2)", 
...
```{r erreurbar5, fig.cap="Comparaison de deux temps de mesure avec `superb` (avec décorrélation)", fig.align='center', out.height="75%", out.width="75%", warning=FALSE, message=FALSE}
superbPlot(jd_intra, 
    WSFactors = "temps(2)", 
    variables = c("temps1", "temps2"),
    plotStyle = "line",
