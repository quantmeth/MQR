...
```{r modlin, include=FALSE, fig.cap="Diagramme de dispersion", fig.align="center", out.height="80%",out.width="80%"}
set.seed(2)
R = matrix(c(1,.9,.9,1),2,2)
X = data.frame((MASS::mvrnorm(n = 10, mu = c(0,0), Sigma = R)))
colnames(X) = c("x","y")
X %>% 
  ggplot(aes(x,y)) + 
  geom_point()+
