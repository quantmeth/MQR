...
```{r regaf, echo = FALSE, fig.cap = "Représentations de la régression et l'analyse factorielle", out.height="75%" , out.width="75%", fig.align = "center"}
...
```{r acpsuj, echo = FALSE, fig.align='center',fig.cap='Représentations des participants selon les variables (gauche) ou les composantes principales (droite).', out.height="75%", out.width="75%"}
r.svd <- svd(jd.acp)
...
```{r varacp, echo = FALSE, fig.align='center', fig.cap="Représentations des vraiables selon les composantes principales.", out.height="75%", out.width="75%"}
