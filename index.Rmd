...
```{r saumon, fig.cap="Cognitions sociales d'un saumon atlantique décédés. Tirés de Bennett et al. 2010, p.4",echo=FALSE, out.width="75%", fig.align="center"}
knitr::include_graphics("image//saumon.PNG")
```
