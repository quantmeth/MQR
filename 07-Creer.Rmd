...
Dans cet exemple, les variances de `x1` et de `x3` sont égales à 2 et 3 respectivement. Si ces deux variables sont additionnées pour créer `y`, l'équation \@ref(eq:eq2) implique que la variance est de $\sigma^2_{x_{1}} + \sigma^2_{x_2} = `r s.x1^2` + `r s.x2^2`= `r s.x1^2+ s.x2^2`$
