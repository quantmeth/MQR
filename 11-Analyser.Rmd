...
> La matrice de corrélation des variables présentées. Parmi les corrélations d'intérêt, un lien remarquable est celui entre `qsec` et `mpg` qui est significatif, $r(`r n`) = `r rr["qsec","mpg"]`, p\ `r pqm`$.
