...
> Une ANOVA est réalisée pour comparer les groupes sur un certain score. Les résultats montrent une différence significative (pour un $\alpha = .05$), $F(`r r.aov$Df[1]`, `r r.aov$Df[2]`) = `r r.aov[1,4]`, p < .001$.
