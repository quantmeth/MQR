...
```{r tukey, fig.cap="Illustration du test de comparaisons multiples de Tukey", out.height="50%", out.width="50%"}
par(mar = c(3, 15, 3, 3))
plot(TukeyHSD(res))
```
...
```{r tukey2, fig.cap="Illustration corrigée du test de comparaisons multiples de Tukey", out.height="50%", out.width="50%"}
