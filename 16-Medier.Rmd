...
> Une analyse de médiation avec bootstrap est effectuée pour tester le lien indirect le lien indirect de `wt` à `mpg` par l'intermédiaire de `hp`. Les résultats montrent un lien indirect significatif de `r eee`, [95%IC\ `r icl`,\ `r icu`]. La Figure\ \@ref(fig:metmed) présente les résultats.
